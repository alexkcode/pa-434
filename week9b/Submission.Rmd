---
title: "Assigment 8"
author: "Alexis Kwan, Ethan Jantz, Jordan Evangelista, & Malley Smith"
date: "3/8/2021"
output:
  html_document:
    df_print: paged
...
vehicle_comparison_crime <- crime %>%
  ...
  mutate(location = case_when(
    grepl("vehicle-commercial|vehicle - commercial|delivery", location,  ignore.case = T) ~ "COMMERCIAL", # grepl checks strings for the presence of a pattern, or set of patterns
...
The above plot had us curious as what "other" crimes were happening, since violent and property crimes are more straightforward.
